...
use App\Models\kelas6\bindkls6;
use App\Models\kelas6\bindkuismodel;
use App\Models\kelas6\kls6bindsubmision;
use App\Models\kelas6\kls6bindsubmitan;

class bindkls6Controller extends Controller
{
    public function index(Request $request){
        if($request->has('keyword')){
            ...
            $data = bindkls6::paginate(10);
            $submit = kls6bindsubmision::orderBy('id','desc')->get();
            $kuis = bindkuismodel::orderBy('id','desc')->get();
            $submited = kls6bindsubmitan::all();
        }
        return view('kelas6/bahasa',['data'=>$data,'kuis'=>$kuis,'submit'=>$submit,'submited'=>$submited]);
    }

    public function create(){
        return view('kelas6/tambah/tambahbind');
    }
...
/**
    ...
    public function add(Request $request){
        ...
        if($request->file('file')==NULL){
            bindkls6::create([
                ...
                $file->move(public_path('filemateri/kelas6/bahasa'),$namafile);
                $deskripsi = $request->deskripsi;
        ...
        return redirect('/kelas6/bindonesia')->with('success','Data berhasil Ditambahkan');
    }

    public function edit($id){
        $matka = bindkls6::find($id);
        return view('kelas6/tambah/ubahbind',['matka' => $matka]);
    }
    ...
    public function update(Request $request, $id){
        if($request->file('file')==NULL){
            ...
            $matka->save();
            return redirect('/kelas6/bindonesia')->with('success','Data Berhasil Diubah');
    ...
    public function destroy($id){
        $matka = bindkls6::find($id);
        $matka->delete();
        return redirect('/kelas6/bindonesia')->with('success', 'Data Telah Dihapus!');
    }

    public function download(Request $request,$file){
        return response()->download(public_path('filemateri/kelas6/bahasa/'.$file));
    }

    public function quiz(){
        
        return view('kelas6/tambah/tambahkuisbindo');
    }
    ...
    public function addsubmission(Request $request){
        ...
        kls6bindsubmision::create([
            // dd($request->all())
            'judul' => $request->judul,
            'bataswaktu' => $request->bataswaktu,
        ]);
        return redirect('/kelas6/bindonesia')->with('success','Submission telah kamu telah terkirim');
    }
    ...
    public function destroysubmit($id){
        $submited = kls6bindsubmitan::find($id);
        $submited->delete();
        return redirect('/kelas6/bindonesia')->with('success', 'Data Telah Dihapus!');
    }
    ...
    public function destroyformsubmit($id){
        $submited = kls6bindsubmision::find($id);
        $submited->delete();
        return redirect('/kelas6/bindonesia')->with('success','Data Telah Dihapus');
    }
    ...
    public function editsubmit($id){
        $submited = kls6bindsubmitan::find($id);
        return view('kelas6/tambah/editsubmisionbind',['submited' => $submited]);
    }
    ...
    public function updatesubmit(Request $request, $id){
        ...
        $submited->save();
        return redirect('/kelas6/bindonesia')->with('success','Tugas anda Berhasil Diubah');
    }
}
