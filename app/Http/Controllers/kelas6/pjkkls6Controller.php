...
use App\Models\kelas6\pjkkls6;
use App\Models\kelas6\pjkkuismodel;
use App\Models\kelas6\kls6pjksubsmision;
use App\Models\kelas6\kls6pjksubmitan;

class pjkkls6Controller extends Controller
{
    public function index(Request $request){
        if($request->has('keyword')){
            // $submit = kls6pjksubsmision::all();
            $submit = kls6pjksubsmision::orderBy('id','desc')->get();
            $kuis = pjkkuismodel::orderBy('id','desc')->get();
            $submited = kls6pjksubmitan::all();
            $data = pjkkls6::where('Topik','LIKE','%'.$request->keyword.'%')
            ...
            $data = pjkkls6::paginate(10);
            $submit = kls6pjksubsmision::orderBy('id','desc')->get();
            $kuis = pjkkuismodel::orderBy('id','desc')->get();
            $submited = kls6pjksubmitan::all();
        }
        return view('kelas6/olahraga',['data'=>$data,'kuis'=>$kuis,'submit'=>$submit,'submited'=>$submited]);
    }

    public function create(){
        return view('kelas6/tambah/tambahpjk');
    }
...
/**
    ...
    public function add(Request $request){
        ...
        if($request->file('file')==NULL){
            pjkkls6::create([
                ...
                $file->move(public_path('filemateri/kelas6/olahraga'),$namafile);
                $deskripsi = $request->deskripsi;
        ...
        return redirect('/kelas6/pjk')->with('success','Data berhasil Ditambahkan');
    }

    public function edit($id){
        $matka = pjkkls6::find($id);
        return view('kelas6/tambah/ubahpjk',['matka' => $matka]);
    }
    ...
    public function update(Request $request, $id){
        if($request->file('file')==NULL){
            ...
            $matka->save();
            return redirect('/kelas6/pjk')->with('success','Data Berhasil Diubah');
    ...
    public function destroy($id){
        $matka = pjkkls6::find($id);
        $matka->delete();
        return redirect('/kelas6/pjk')->with('success', 'Data Telah Dihapus!');
    }

    public function download(Request $request,$file){
        return response()->download(public_path('filemateri/kelas6/olahraga/'.$file));
    }

    public function quiz(){
        
        return view('kelas6/tambah/tambahkuispjk');
    }
    ...
    public function addsubmission(Request $request){
        ...
        kls6pjksubsmision::create([
            // dd($request->all())
            'judul' => $request->judul,
            'bataswaktu' => $request->bataswaktu,
        ]);
        return redirect('/kelas6/pjk')->with('success','Submission telah kamu telah terkirim');
    }
    ...
    public function destroysubmit($id){
        $submited = kls6pjksubmitan::find($id);
        $submited->delete();
        return redirect('/kelas6/pjk')->with('success', 'Data Telah Dihapus!');
    }
    ...
    public function destroyformsubmit($id){
        $submited = kls6pjksubsmision::find($id);
        $submited->delete();
        return redirect('/kelas6/pjk')->with('success','Data Telah Dihapus');
    }
    ...
    public function editsubmit($id){
        $submited = kls6pjksubmitan::find($id);
        return view('kelas6/tambah/editsubmisionpjk',['submited' => $submited]);
    }
    ...
    public function updatesubmit(Request $request, $id){
        ...
        $submited->save();
        return redirect('/kelas6/pjk')->with('success','Tugas anda Berhasil Diubah');
    }
}
