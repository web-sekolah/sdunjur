...
use App\Models\kelas2\bindkls2;
use App\Models\kelas2\bindkuismodel;
use App\Models\kelas2\kls2bindsubmision;
use App\Models\kelas2\kls2bindsubmitan;

class bindkls2Controller extends Controller
{
    public function index(Request $request){
        if($request->has('keyword')){
            ...
            $data = bindkls2::paginate(10);
            $submit = kls2bindsubmision::orderBy('id','desc')->get();
            $kuis = bindkuismodel::orderBy('id','desc')->get();
            $submited = kls2bindsubmitan::all();
        }
        return view('kelas2/bahasa',['data'=>$data,'kuis'=>$kuis,'submit'=>$submit,'submited'=>$submited]);
    }

    public function create(){
        return view('kelas2/tambah/tambahbind');
    }
...
/**
    ...
    public function add(Request $request){
        ...
        if($request->file('file')==NULL){
            bindkls2::create([
                ...
                $file->move(public_path('filemateri/kelas2/bahasa'),$namafile);
                $deskripsi = $request->deskripsi;
        ...
        return redirect('/kelas2/bindonesia')->with('success','Data berhasil Ditambahkan');
    }

    public function edit($id){
        $matka = bindkls2::find($id);
        return view('kelas2/tambah/ubahbind',['matka' => $matka]);
    }
    ...
    public function update(Request $request, $id){
        if($request->file('file')==NULL){
            ...
            $matka->save();
            return redirect('/kelas2/bindonesia')->with('success','Data Berhasil Diubah');
    ...
    public function destroy($id){
        $matka = bindkls2::find($id);
        $matka->delete();
        return redirect('/kelas2/bindonesia')->with('success', 'Data Telah Dihapus!');
    }

    public function download(Request $request,$file){
        return response()->download(public_path('filemateri/kelas2/bahasa/'.$file));
    }

    public function quiz(){
        
        return view('kelas2/tambah/tambahkuisbindo');
    }
    ...
    public function addsubmission(Request $request){
        ...
        kls2bindsubmision::create([
            // dd($request->all())
            'judul' => $request->judul,
            'bataswaktu' => $request->bataswaktu,
        ]);
        return redirect('/kelas2/bindonesia')->with('success','Submission telah kamu telah terkirim');
    }
    ...
    public function destroysubmit($id){
        $submited = kls2bindsubmitan::find($id);
        $submited->delete();
        return redirect('/kelas2/bindonesia')->with('success', 'Data Telah Dihapus!');
    }
    ...
    public function destroyformsubmit($id){
        $submited = kls2bindsubmision::find($id);
        $submited->delete();
        return redirect('/kelas2/bindonesia')->with('success','Data Telah Dihapus');
    }
    ...
    public function editsubmit($id){
        $submited = kls2bindsubmitan::find($id);
        return view('kelas2/tambah/editsubmisionbind',['submited' => $submited]);
    }
    ...
    public function updatesubmit(Request $request, $id){
        ...
        $submited->save();
        return redirect('/kelas2/bindonesia')->with('success','Tugas anda Berhasil Diubah');
    }
}
