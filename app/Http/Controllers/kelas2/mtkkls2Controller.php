...
use App\Models\kelas2\mtkkls2;
use App\Models\kelas2\mtkkuismodel;
use App\Models\kelas2\kls2mtksubmision;
use App\Models\kelas2\kls2mtksubmitan;

class mtkkls2Controller extends Controller
{
    public function index(Request $request){
        if($request->has('keyword')){
            ...
            $data = mtkkls2::paginate(10);
            $submit = kls2mtksubmision::orderBy('id','desc')->get();
            $kuis = mtkkuismodel::orderBy('id','desc')->get();
            $submited = kls2mtksubmitan::all();
        }
        return view('kelas2/matematika',['data'=>$data,'kuis'=>$kuis,'submit'=>$submit,'submited'=>$submited]);
    }

    public function create(){
        return view('kelas2/tambah/tambahmtk');
    }
...
/**
    ...
    public function add(Request $request){
        ...
        if($request->file('file')==NULL){
            mtkkls2::create([
                ...
                $file->move(public_path('filemateri/kelas2/matematika'),$namafile);
                $deskripsi = $request->deskripsi;
        ...
        return redirect('/kelas2/matematika')->with('success','Data berhasil Ditambahkan');
    }

    public function edit($id){
        $matka = mtkkls2::find($id);
        return view('kelas2/tambah/ubahmtk',['matka' => $matka]);
    }
    ...
    public function update(Request $request, $id){
        if($request->file('file')==NULL){
            ...
            $matka->save();
            return redirect('/kelas2/matematika')->with('success','Data Berhasil Diubah');
    ...
    public function destroy($id){
        $matka = mtkkls2::find($id);
        $matka->delete();
        return redirect('/kelas2/matematika')->with('success', 'Data Telah Dihapus!');
    }

    public function download(Request $request,$file){
        return response()->download(public_path('filemateri/kelas2/matematika/'.$file));
    }

    public function quiz(){
        
        return view('kelas2/tambah/tambahkuis');
    }
    ...
    public function addsubmission(Request $request){
        ...
        kls2mtksubmision::create([
            // dd($request->all())
            'judul' => $request->judul,
            'bataswaktu' => $request->bataswaktu,
        ]);
        return redirect('/kelas2/matematika')->with('success','Submission telah kamu telah terkirim');
    }
    ...
    public function destroysubmit($id){
        $submited = kls2mtksubmitan::find($id);
        $submited->delete();
        return redirect('/kelas2/matematika')->with('success', 'Data Telah Dihapus!');
    }
    ...
    public function destroyformsubmit($id){
        $submited = kls2mtksubmision::find($id);
        $submited->delete();
        return redirect('/kelas2/matematika')->with('success','Data Telah Dihapus');
    }
    ...
    public function editsubmit($id){
        $submited = kls2mtksubmitan::find($id);
        return view('kelas2/tambah/editsubmision',['submited' => $submited]);
    }
    ...
    public function updatesubmit(Request $request, $id){
        ...
        $submited->save();
        return redirect('/kelas2/matematika')->with('success','Tugas anda Berhasil Diubah');
    }
}
