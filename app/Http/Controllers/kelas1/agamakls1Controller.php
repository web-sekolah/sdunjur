...
use App\Models\kelas1\agamakls1;
use App\Models\kelas1\agamakuismodel;
use App\Models\kelas1\kls1agamasubsmision;
use App\Models\kelas1\kls1agamasubmitan;

class agamakls1Controller extends Controller
{
    public function index(Request $request){
        ...
        return view('kelas1/agama',['data'=>$data,'kuis'=>$kuis,'submit'=>$submit,'submited'=>$submited]);
    }

    public function create(){
        return view('kelas1/tambah/tambahagama');
    }
...
/**
    ...
    public function add(Request $request){
        ...
        if($request->file('file')==NULL){
            agamakls1::create([
                ...
                $file->move(public_path('filemateri/kelas1/agama'),$namafile);
                $deskripsi = $request->deskripsi;
        ...
        return redirect('/kelas1/agama')->with('success','Data berhasil Ditambahkan');
    }

    public function edit($id){
        $matka = agamakls1::find($id);
        return view('kelas1/tambah/ubahagama',['matka' => $matka]);
    }
    ...
    public function update(Request $request, $id){
        if($request->file('file')==NULL){
            ...
            $matka->save();
            return redirect('/kelas1/agama')->with('success','Data Berhasil Diubah');
    ...
    public function destroy($id){
        $matka = agamakls1::find($id);
        $matka->delete();
        return redirect('/kelas1/agama')->with('success', 'Data Telah Dihapus!');
    }

    public function download(Request $request,$file){
        return response()->download(public_path('filemateri/kelas1/agama/'.$file));
    }

    public function quiz(){
        
        return view('kelas1/tambah/tambahkuisagama');
    }
    ...
    public function addsubmission(Request $request){
        ...
        kls1agamasubsmision::create([
            // dd($request->all())
            'judul' => $request->judul,
            'bataswaktu' => $request->bataswaktu,
        ]);
        return redirect('/kelas1/agama')->with('success','Submission telah kamu telah terkirim');
    }
    ...
    {   
        ...
        $submited = new kls1agamasubmitan();
        $submited->nama = $nama;
    ...
    public function destroysubmit($id){
        $submited = kls1agamasubmitan::find($id);
        $submited->delete();
        return redirect('/kelas1/agama')->with('success', 'Data Telah Dihapus!');
    }
    ...
    public function destroyformsubmit($id){
        $submited = kls1agamasubsmision::find($id);
        $submited->delete();
        return redirect('/kelas1/agama')->with('success','Data Telah Dihapus');
    }
    ...
    public function editsubmit($id){
        $submited = kls1agamasubmitan::find($id);
        return view('kelas1/tambah/editsubmisionagama',['submited' => $submited]);
    }
    ...
    public function updatesubmit(Request $request, $id){
        ...
        $submited->save();
        return redirect('/kelas1/agama')->with('success','Tugas anda Berhasil Diubah');
    }
}
