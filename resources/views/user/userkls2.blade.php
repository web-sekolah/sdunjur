    ...
    <div class="row">
        <div class="col-md-2">
          <div class="list-group list" id="list-tab" role="tablist">
            ...
            <a class="list-group-item list-group-item-action active" href="/userkls2">Kelas 2</a>
        ...
        <div class="col-md-10">
          <div class="tab-content bg-light" id="nav-tabContent">
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list"><br>
                <div class="row">
                <div class="col-md-7">                    
                    <h4 class="container text-muted"><i class="fas fa-user-graduate"></i> DAFTAR SISWA KELAS 2</h4>
                </div>
                <div class="col-md-5">
                    <form class="d-flex container">
                        ...
                        <a href="/userkls2" class="btn btn-outline-secondary" href=""><i class="fas fa-sync-alt"></i></a>
                      </form>
                </div>
                </div>
                  <br>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content modalhapus" style="background-color: white;">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="/user/kelas2/hapus/{{$item->id}}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus akun</a>
                              </div>
                            </div>
                          </div>
                        </div>
