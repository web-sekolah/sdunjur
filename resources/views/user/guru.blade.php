    ...
    <div class="row">
        <div class="col-md-2">
          <div class="list-group list" id="list-tab" role="tablist">
            ...
            <a class="list-group-item list-group-item-action active" href="/userguru">Guru</a>
          </div>
        </div>
        <div class="col-md-10">
            ...
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list"><br>
                ...
                <div class="col-md-5">
                    <form class="d-flex container">
                        <input name="keyword" class="form-control me-2" type="text" placeholder="Cari guru ...." aria-label="Search">
                        <button class="btn btn-outline-success me-2" type="submit"><i class="fas fa-search"></i></button>
                        <a href="/userguru" class="btn btn-outline-secondary" href=""><i class="fas fa-sync-alt"></i></a>
                      </form>
                </div>
                </div>
                  <br>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content modalhapus" style="background-color: white;">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="/user/guru/hapus/{{$item->id}}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus akun</a>
                              </div>
                            </div>
                          </div>
                        </div>
