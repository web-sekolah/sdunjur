      ...
      <div class="row">
        <div class="col-md-2 mb-2">
          <div class="list-group" id="list-tab" role="tablist">
            ...
            <a class="list-group-item list-group-item-action active" href="/kelas5/ObrolanKelas/tanyajawab/agama">Agama</a>
        ...
        <div class="col-md-10 bg-light">
          <div class="tab-content" id="nav-tabContent" style="overflow-y: scroll; height:400px;">
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                <form class="container mt-3 ajukan-pertanyaan" action="/kelas5/ObrolanKelas/tanyajawab/agama/AddComment" enctype="multipart/form-data" method="post" >
                    {{ method_field('POST') }}
                    @csrf
                    <div class="d-flex">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content modalhapus" style="background-color: white;">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="/kelas5/ObrolanKelas/tanyajawab/agama/hapus/{{$komen->id}}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus Pertanyaan</a>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="container replyform{{$komen->id}}">
                    <form action="/kelas5/ObrolanKelas/tanyajawab/agama/addreply" method="post" enctype="multipart/form-data">
                      {{ method_field('POST') }}
                      @csrf
