...
<html lang="en">
  ...
  <body style="background-image: url('{{ asset('gambar/bgberanda.jpg') }}')">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="/kelas6/ObrolanKelas/tanyajawab/senibudaya" class="nav-link container text-light" aria-current="page" href="/kelas6/ObrolanKelas/tanyajawab/senibudaya"><i class="fas fa-comments"></i> Ruang Tanya</a>
                  </li>
    ...
    <div class="container">
      ...
      @if (auth()->user()->level=="guru")
      <a class="btn btn-sm btnkelas bg-transparent text-light" href="/kelas6/sbd/tambah">+ Tambah Materi</a>
      @endif
                      ...
                      <div class="card activitycard">
                          <div class="card-header d-flex">
                              ...
                              <div class="ms-auto" style="float: right;">
                                @if (auth()->user()->level=="guru")
                                <a href="/kelas6/sbd/ubah/{{ $item->id }}" class="btn btn-success btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content modalhapus" style="background-color: white;">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="/kelas6/sbd/hapus/{{ $item->id }}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus Materi</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                          ...
                          <div class="card-body">
                            ...
                            @endif
                            @if ($item->file != NULL)
                              <a href="/kelas6/sbd/download/{{$item->file}}" class="btn btn-outline-info"><i class="fas fa-file-alt"></i> Download Materi</a>
                            @endif
              ...
              <div class="card-header">
                <ul class="nav nav-pills card-header-pills">
                  <li class="nav-item ">
                    <div class="d-flex">
                      @if (auth()->user()->level=="guru")
                      <a class="btn btn-primary fw-bold ms-auto" href="/kelas6/sbd/kuis/tambah"><i class="fas fa-plus-square"></i> Tambah Quis</a>&nbsp;
                      @endif
                      <a href="/kelas6/sbd" class="btn btn-outline-secondary"><i class="fas fa-sync-alt refresh"></i></a>&nbsp;
                        ...
                        <div class="modal fade" id="deletekuis{{$quiz->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content modalhapus" style="background-color: white;">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fas fa-times"></i> Batal</button>
                                <a href="/kelas6/sbd/kuis/hapus/{{ $quiz->id }}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus Materi</a>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="card">
                ...
                <div class="container">
                  ...
                  <div class="card mb-4 formtambah">
                    ...
                    <div class="card-body container">
                      {{-- alert error --}}
                      <center>
                      <form class="" action="/kelas6/sbd/addsubmission" enctype="multipart/form-data" method="post" >
                        {{ method_field('POST') }}
                        @csrf
                        <table cellpadding="2">
                          <tr>
                ...
                <div class="card text-center" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                  <div class="card-body">
                      ...
                      <div class="modal fade" id="deletekuis{{$sub->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content modalhapus" style="background-color: white;">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fas fa-times"></i> Batal</button>
                              <a href="/kelas6/sbd/submisionform/delete/{{$sub->id}}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus Form Submit</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    {{-- form-submitan = /kelas6/sbd/addsubmit --}}
                    <div class="col-8 container">
                    <form class="container mb-2" action="/kelas6/sbd/addsubmit" enctype="multipart/form-data" method="post" class="dropzone dz-clickable" >
                      {{ method_field('POST') }}
                      @csrf
                      ...
                      <div class="offcanvas-body">
                        <table class="table table-striped table-hover">
                          ...
                          <tr>
                            ...
                            <td>{{$tugas->nama}}</td>
                            <td>
                              <a href="/kelas6/sbd/submit/download/{{$tugas->file}}" class="link-secondary"><i class="fas fa-file-download"> {{$tugas->file}}</i></a>
                            </td>
                  ...
                  <table class="table table-striped table-hover">
                    <tr>
                      <td>File</td>
                      <td>:</td>
                      <td><a href="/kelas6/sbd/submit/download/{{$tugas->file}}" class="link-secondary"><i class="fas fa-file-download"> {{$tugas->file}}</i></a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>
                        <a href="/kelas6/sbd/submit/ubah/{{$tugas->id}}" class="link-secondary"><i class="fas fa-edit"></i> Edit</a>&nbsp;
                      </td>
                      <td></td>
                      <td>
                          ...
                          <div class="modal fade" id="exampleModal{{$tugas->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content modalhapus" style="background-color: white;">
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fas fa-times"></i> Batal</button>
                                  <a href="/kelas6/sbd/destroysubmit/{{$tugas->id}}" id="#deletekuis{{$sub->id}}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus Tugas</a>
                                </div>
                              </div>
                            </div>
                          </div>
