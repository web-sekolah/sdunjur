...
<html lang="en">
  ...
  <body style="background-image: url('{{ asset('gambar/bgberanda.jpg') }}')">
    ...
    <div class="container">
      <a class="btn btn-sm btnkelas bg-transparent text-light" href="/kelas5/olahraga"><- Kembali</a>
      {{-- Modal pencarian --}}
      ...
      <div class="container formtambah col-10 p-3 bg-light" style="max-width: 800px;">
        <form action="/kelas5/pjk/kuis/simpan" enctype="multipart/form-data" method="post" class="form-group">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-6">
