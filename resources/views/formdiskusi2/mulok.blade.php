        ...
        @include('layouts.logo')
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                  ...
                  <li class="nav-item">
                    <a href="/kelas2" class="nav-link container text-light" aria-current="page" href="/kelas2"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Kelas 2</a>
                  </li>
      ...
      <div class="row">
        <div class="col-md-2 mb-2">
          <div class="list-group" id="list-tab" role="tablist">
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/matematika">Matematika</a>
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/bindonesia">B.Indonesia</a>
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/ipa">IPA</a>
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/ips">IPS</a>
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/ppkn">PPKN</a>
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/agama">Agama</a>
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/penjas">Olahraga</a>
            <a class="list-group-item list-group-item-action" href="/kelas2/ObrolanKelas/tanyajawab/senibudaya">Seni Budaya</a>
            <a class="list-group-item list-group-item-action active" href="/kelas2/ObrolanKelas/tanyajawab/muatanlokal">Muatan Lokal</a><br>
        ...
        <div class="col-md-10 bg-light">
          <div class="tab-content" id="nav-tabContent" style="overflow-y: scroll; height:400px;">
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                <form class="container mt-3 ajukan-pertanyaan" action="/kelas2/ObrolanKelas/tanyajawab/muatanlokal/AddComment" enctype="multipart/form-data" method="post" >
                    {{ method_field('POST') }}
                    @csrf
                    <div class="d-flex">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content modalhapus" style="background-color: white;">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="/kelas2/ObrolanKelas/tanyajawab/muatanlokal/hapus/{{$komen->id}}" class="btn btn-primary"><i class="fas fa-trash-alt"></i> Hapus Pertanyaan</a>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="container replyform{{$komen->id}}">
                    <form action="/kelas2/ObrolanKelas/tanyajawab/muatanlokal/addreply" method="post" enctype="multipart/form-data">
                      {{ method_field('POST') }}
                      @csrf
