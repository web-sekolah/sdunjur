  ...
  <body style="background-image: url('{{ asset('gambar/bgberanda.jpg') }}')">
    <nav class="navbar container mt-3 navbar-expand-lg navbar-light bg-transparent">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a href="kelas3/ObrolanKelas" class="nav-link container text-light" aria-current="page" href="kelas3/ObrolanKelas"><i class="fas fa-comments"></i> Ruang Bertanya</a>
                </li>
              <li class="nav-item">
      ...
      <div class="container bg-light p-3" style="box-shadow: rgba(0, 0, 0, 0.15) 0px 15px 25px, rgba(0, 0, 0, 0.05) 0px 5px 10px; width: max-content; border-radius: 0px 0px 100px 100px;">
        <h2 class="kelas text-center">KELAS 3</h2><br>
      </div>
      <br><br>
      ...
      <div class="container ">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <a href="{{ route('kelas3.mtk') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
          </div>
        </div>
        </div>
        </div>
        ...
        <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <a href="{{ route('kelas3.bind') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
              </div>
            </div>
            </div>
            </div>
            ...
            <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <a href="{{ route('kelas3.ipa') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
                  </div>
                </div>
                </div>
                </div>
                ...
                <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <a href="{{ route('kelas3.ips') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
                      </div>
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
                        ...
                        <div class="col-md-8">
                          <div class="card-body">
                            ...
                            <a href="{{ route('kelas3.pjk') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
                          </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
                            ...
                            <div class="col-md-8">
                              <div class="card-body">
                                ...
                                <a href="{{ route('kelas3.sbd') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
                              </div>
                            </div>
                            </div>
                            </div>
                            ...
                            <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
                                ...
                                <div class="col-md-8">
                                  <div class="card-body">
                                    ...
                                    <a href="{{ route('kelas3.mulok') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
                                  </div>
                                </div>
                                </div>
                                </div>
                                ...
                                <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
                                    ...
                                    <div class="col-md-8">
                                      <div class="card-body">
                                        ...
                                        <a href="{{ route('kelas3.agama') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
                                      </div>
                                    </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="card container card-mapel col-mb-3 mt-4" style="max-width: 500px;">
                                    ...
                                    <div class="col-md-8">
                                      <div class="card-body">
                                        ...
                                        <a href="{{ route('kelas3.ppkn') }}" style="color: #EC7063;" class="materi fw-bold">Lihat Materi <i class="fas fa-hand-point-right"></i></a>
                                      </div>
                                    </div>
                                    </div>
                                  </div>   
